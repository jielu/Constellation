...
public class Test_Leetcode extends Configured implements Tool {
	private Test_Leetcode() {
	} // singleton
...
//		 }
		...
		JobConf grepJob = new JobConf(getConf(), Test_Leetcode.class);
		
		String junit4_lib = "/leetcode/lib/junit4.jar";
		String junit3_lib = "/leetcode/lib/junit3.jar";
		String insect_lib = "/leetcode/lib/insect.jar";
		
		String instrumented_classes_path = "/leetcode/instrumented-src-class/";
		String testcases_path = "/leetcode/test-class/";

		String input_path = "/leetcode/testClass";
		String output_path = "/leetcode/output";
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new Test_Leetcode(), args);
		System.exit(res);
	}
