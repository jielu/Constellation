...
public class PlusOne4Test extends TestCase {
    ...
    public PlusOne4Test(String test) {
    	super(test);
    }
    
	public static Test suite() {
    	TestSuite test = new TestSuite();
    	test.addTest(new PlusOne4Test("test74"));
    	test.addTest(new PlusOne4Test("test75"));
    	test.addTest(new PlusOne4Test("test76"));
    	test.addTest(new PlusOne4Test("test77"));
    	test.addTest(new PlusOne4Test("test78"));
    	test.addTest(new PlusOne4Test("test79"));
    	test.addTest(new PlusOne4Test("test80"));
    	test.addTest(new PlusOne4Test("test81"));
    	test.addTest(new PlusOne4Test("test82"));
    	test.addTest(new PlusOne4Test("test83"));
    	test.addTest(new PlusOne4Test("test84"));
    	test.addTest(new PlusOne4Test("test85"));
    	test.addTest(new PlusOne4Test("test86"));
    	test.addTest(new PlusOne4Test("test87"));
    	test.addTest(new PlusOne4Test("test88"));
    	test.addTest(new PlusOne4Test("test89"));
    	test.addTest(new PlusOne4Test("test90"));
    	test.addTest(new PlusOne4Test("test91"));
    	test.addTest(new PlusOne4Test("test92"));
    	test.addTest(new PlusOne4Test("test93"));
    	test.addTest(new PlusOne4Test("test94"));
    	return test;
    }
