...
import org.apache.commons.collections.Sleep;
...
public class TestSetUniqueList extends AbstractTestList {
	...
	public Object[] getFullNonNullElements() {
		...
		return new Object[] { new String(""), new String("One"),
				new Integer(2), "Three", new Integer(4), new Double(5),
				new Float(6), "Seven", "Eight", new String("Nine"),
				new Integer(10), new Short((short) 11), new Long(12),
				"Thirteen", "14", "15", new Byte((byte) 16) };
	}
	...
	public void testCollectionAddAll() {
		...
		assertEquals("Size should increase after addAll", size
	...
	public void testListSetByIndex() {
		...
		assertEquals(new Long(1000), getList().get(1)); // set into 2, but
														// shifted down to 1
	}
	...
	public void testAdd() {
		final SetUniqueList lset = new SetUniqueList(new ArrayList(),
				new HashSet());
	...
	public void testAddAll() {
		...
		lset.addAll(Arrays.asList(new Integer[] { new Integer(1),
				new Integer(1) }));
	...
	public void testSetDownwardsInList() {
		/*
		 * Checks the following semantics [a,b] set(0,b): [b]->a So UniqList
		 * contains [b] and a is returned
		 */
	...
	public void testSetInBiggerList() {
		/*
		 * Checks the following semantics [a,b,c] set(0,b): [b,c]->a So UniqList
		 * contains [b,c] and a is returned
		 */
		ArrayList l = new ArrayList();
		HashSet s = new HashSet();
		final SetUniqueList ul = new SetUniqueList(l, s);
	...
	public void testSetUpwardsInList() {
		/*
		 * Checks the following semantics [a,b,c] set(1,a): [a,c]->b So UniqList
		 * contains [a,c] and b is returned
		 */
		ArrayList l = new ArrayList();
		HashSet s = new HashSet();
		final SetUniqueList ul = new SetUniqueList(l, s);
	...
	// "D:/dev/collections/data/test/SetUniqueList.emptyCollection.version3.1.obj");
	// resetFull();
	// writeExternalFormToDisk((java.io.Serializable) collection,
...
//	public void testCollections307_1() {
...
//	}
//
//	public void testCollections307_2() {
//		List list = new ArrayList();
//		List uniqueList = SetUniqueList.decorate(list);
//
//		String hello = "Hello";
...
//	public void testCollections307_3() {
//		List list = new ArrayList();
...
//	}
//
//	public void testCollections307_4() {
//		List list = new ArrayList();
//		List uniqueList = new SetUniqueList307(list, new java.util.TreeSet());
//
//		String hello = "Hello";
...
//	public void testIntCollectionAddAll_1() {
...
//		collection = Arrays.asList(new Integer[] { firstNewElement,
//				secondNewElement });
//		list.addAll(0, collection);
//		assertEquals("Unique elements should be added.", 3, list.size());
//		assertEquals("First new element should be at index 0", firstNewElement,
//				list.get(0));
//		assertEquals("Second new element should be at index 1",
//				secondNewElement, list.get(1));
//		assertEquals("Existing element should shift to index 2",
//				existingElement, list.get(2));
//	}
//	
...
//	public void testIntCollectionAddAll_2() {
//		// make a SetUniqueList with one element
//		List list = new SetUniqueList(new ArrayList(), new HashSet());
//		final Integer existingElement = new Integer(1);
//		list.add(existingElement);
...
//		collection = Arrays.asList(new Integer[] { existingElement,
//				thirdNewElement });
//		list.addAll(0, collection);
//		assertEquals(
//				"Duplicate element should not be added, unique element should be added.",
//				4, list.size());
//		assertEquals("Third new element should be at index 0", thirdNewElement,
//				list.get(0));
//	}
}
